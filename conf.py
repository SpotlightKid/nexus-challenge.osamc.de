...
# (translatable)
CONTENT_FOOTER = """\
Contents &copy; {date} <a href="https://osamc.de/">{author}</a><br />
<a rel="license" href="http://creativecommons.org/licenses/by/4.0/"><img
  alt="Creative Commons Lizenzvertrag" style="border-width:0"
  src="https://i.creativecommons.org/l/by/4.0/80x15.png" /></a>&nbsp;This work is licensed under a
